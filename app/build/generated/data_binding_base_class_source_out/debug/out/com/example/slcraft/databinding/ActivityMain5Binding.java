...
public final class ActivityMain5Binding implements ViewBinding {
  ...
  @NonNull
  public final TextView Txt1p5;

  @NonNull
  public final ImageView imageView;

  private ActivityMain5Binding(@NonNull ConstraintLayout rootView, @NonNull TextView Txt1p5,
  ...
  public static ActivityMain5Binding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.Txt1p5;
      TextView Txt1p5 = ViewBindings.findChildViewById(rootView, id);
      if (Txt1p5 == null) {
        break missingId;
      }
      ...
      return new ActivityMain5Binding((ConstraintLayout) rootView, Txt1p5, imageView);
    }
